...
#include "../include/readex_intraphase_model.h"
 ...
 */
void ReadexIntraphaseModelPlugin::initialize(DriverContext* context, ScenarioPoolSet* pool_set) {
 ...
 *
 */
void ReadexIntraphaseModelPlugin::startTuningStep(void) {
 ...
 *
 */
bool ReadexIntraphaseModelPlugin::analysisRequired(StrategyRequest** strategy) {
    return false;
}
 ...
 *
 */
void ReadexIntraphaseModelPlugin::createScenarios(void) {
 ...
 *
 */
void ReadexIntraphaseModelPlugin::prepareScenarios(void) {
 ...
 *
 */
void ReadexIntraphaseModelPlugin::defineExperiment(int numprocs, bool& analysisRequired, StrategyRequest** strategy) {
 ...
 *
 */
bool ReadexIntraphaseModelPlugin::restartRequired(std::string& env, int& numprocs, std::string& command, bool& is_instrumented) {
 ...
 *
 */
bool ReadexIntraphaseModelPlugin::searchFinished(void) {
 ...
 *
 */
void ReadexIntraphaseModelPlugin::finishTuningStep(void) {
 ...
 *
 */
bool ReadexIntraphaseModelPlugin::tuningFinished(void) {
...
void ReadexIntraphaseModelPlugin::insertExtraInfo( list<MetaProperty> *properties, double& cpuEnergy, double& time, double& nodeEnergy, INT64& instances,
...
int ReadexIntraphaseModelPlugin::getTuningValue(int scenario_id, int tp) {
 ...
 * @ingroup ReadexIntraphasePlugin
 */
Advice* ReadexIntraphaseModelPlugin::getAdvice(void) {
 ...
 *
 */
void ReadexIntraphaseModelPlugin::finalize() {
 ...
 *
 */
void ReadexIntraphaseModelPlugin::terminate() {
...
IPlugin* getPluginInstance(void) {
    ...
    return new ReadexIntraphaseModelPlugin();
}
