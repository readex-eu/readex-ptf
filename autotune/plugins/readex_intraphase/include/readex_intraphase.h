...
#ifndef READEX_INTRAPHASE_PLUGIN_H_
#define READEX_INTRAPHASE_PLUGIN_H_
...
class ReadexIntraphasePlugin : public IPlugin {
    ...
    public:
        ...
        void insertExtraInfo( list< MetaProperty >*            properties,
                              double&                          cpuEnergy,
                              double&                          time,
                              double&                          nodeEnergy,
                              INT64&                           instances,
