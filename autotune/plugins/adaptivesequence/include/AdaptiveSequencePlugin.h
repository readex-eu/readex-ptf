...
/**
   @defgroup AdaptiveSequencePlugin Adaptive Sequence Plugin
   @ingroup AutotunePlugins
 */

#ifndef ADAPTIVE_SEQUENCE_PLUGIN_H_
#define ADAPTIVE_SEQUENCE_PLUGIN_H_
...
class AdaptiveSequencePlugin : public IPlugin {
...
void parseConfig( const char*             filename,
                  AdaptiveSequencePlugin* plugin );

#endif /* ADAPTIVE_SEQUENCE_PLUGIN_H_ */
