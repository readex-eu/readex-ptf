 ...
 */
void UfsTaurusPlugin::initialize( DriverContext*   context,
                                   ScenarioPoolSet* pool_set ) {
    psc_dbgmsg( PSC_SELECTIVE_DEBUG_LEVEL( AutotunePlugins ), "UfsTaurusPlugin: call to initialize()\n" );


    this->context = context;
    this->pool_set = pool_set;

    psc_dbgmsg( PSC_SELECTIVE_DEBUG_LEVEL( AutotunePlugins ), "UfsTaurusPlugin: got pool and context\n" );
    /*
    ...
    psc_dbgmsg( PSC_SELECTIVE_DEBUG_LEVEL( AutotunePlugins ), "UfsTaurusPlugin: got argc and argv\n" );
    ...
    psc_dbgmsg( PSC_SELECTIVE_DEBUG_LEVEL( AutotunePlugins ), "UfsTaurusPlugin: got options\n" );

    TuningParameter* cpuFrequnecy = new TuningParameter();
    cpuFrequnecy->setId( 0 );
    cpuFrequnecy->setName( "UNCORE_FREQ" );
    ...
    psc_dbgmsg( PSC_SELECTIVE_DEBUG_LEVEL( AutotunePlugins ), "UfsTaurusPlugin: set freq\n" );
...
//    psc_dbgmsg( PSC_SELECTIVE_DEBUG_LEVEL( AutotunePlugins ), "UfsTaurusPlugin:"
...
//                min_freq_str.c_str(), max_freq_str.c_str(), freq_step_str.c_str());
    ...
    psc_dbgmsg( PSC_SELECTIVE_DEBUG_LEVEL( AutotunePlugins ), "UfsTaurusPlugin plugin: Tuning parameter is: %s\n\n",
                results.c_str() );
    ...
    psc_dbgmsg( PSC_SELECTIVE_DEBUG_LEVEL( AutotunePlugins ), "UfsTaurusPlugin: initialize() finisehd \n\n");
}
 ...
 *
 */
void UfsTaurusPlugin::startTuningStep( void ) {
    psc_dbgmsg( PSC_SELECTIVE_DEBUG_LEVEL( AutotunePlugins ), "UfsTaurusPlugin: call to startTuningStep()\n" );
    ...
    psc_dbgmsg( PSC_SELECTIVE_DEBUG_LEVEL( AutotunePlugins ), "UfsTaurusPlugin: call to startTuningStep() finished\n" );
}
 ...
 *
 */
bool UfsTaurusPlugin::analysisRequired( StrategyRequest** strategy ) {
    return false;
}
 ...
 *
 */
void UfsTaurusPlugin::createScenarios( void ) {
    psc_dbgmsg( PSC_SELECTIVE_DEBUG_LEVEL( AutotunePlugins ), "UfsTaurusPlugin: call to createScenarios()\n" );

    searchAlgorithm->createScenarios();
    psc_dbgmsg( PSC_SELECTIVE_DEBUG_LEVEL( AutotunePlugins ), "UfsTaurusPlugin: call to createScenarios() finished\n" );
}
 ...
 *
 */
void UfsTaurusPlugin::prepareScenarios( void ) {
    psc_dbgmsg( PSC_SELECTIVE_DEBUG_LEVEL( AutotunePlugins ), "UfsTaurusPlugin: call to prepareScenarios()\n" );
 ...
 *
 */
void UfsTaurusPlugin::defineExperiment( int               numprocs,
                                         bool&             analysisRequired,
                                         StrategyRequest** strategy ) {
    psc_dbgmsg( PSC_SELECTIVE_DEBUG_LEVEL( AutotunePlugins ), "UfsTaurusPlugin: call to defineExperiment()\n" );
...
//    scenario->setSingleTunedRegionWithPropertyRank( appl->get_phase_region(), EXECTIME, 0 );
    ...
    psc_dbgmsg( PSC_SELECTIVE_DEBUG_LEVEL( AutotunePlugins ), "UfsTaurusPlugin: call to defineExperiment() finished\n" );
 ...
 *
 */
bool UfsTaurusPlugin::restartRequired( std::string& env,
                                        int&         numprocs,
                                        std::string& command,
                                        bool&        is_instrumented ) {
    psc_dbgmsg( PSC_SELECTIVE_DEBUG_LEVEL( AutotunePlugins ), "UfsTaurusPlugin: call to restartRequired()\n" );
 ...
 *
 */
bool UfsTaurusPlugin::searchFinished( void ) {
    psc_dbgmsg( PSC_SELECTIVE_DEBUG_LEVEL( AutotunePlugins ), "UfsTaurusPlugin: call to searchFinished()\n" );
 ...
 *
 */
void UfsTaurusPlugin::finishTuningStep( void ) {
    psc_dbgmsg( PSC_SELECTIVE_DEBUG_LEVEL( AutotunePlugins ), "UfsTaurusPlugin: call to processResults()\n" );
}
 ...
 *
 */
bool UfsTaurusPlugin::tuningFinished( void ) {
    psc_dbgmsg( PSC_SELECTIVE_DEBUG_LEVEL( AutotunePlugins ), "UfsTaurusPlugin: call to tuningFinished()\n" );
    return true;
}
 ...
 * @ingroup UfsTaurusPlugin
 */
Advice* UfsTaurusPlugin::getAdvice( void ) {

    psc_dbgmsg( PSC_SELECTIVE_DEBUG_LEVEL( AutotunePlugins ), "UfsTaurusPlugin: call to getAdvice()\n" );
 ...
 *
 */
void UfsTaurusPlugin::finalize() {
    psc_dbgmsg( PSC_SELECTIVE_DEBUG_LEVEL( AutotunePlugins ), "UfsTaurusPlugin: call to finalize()\n" );
 ...
 *
 */
void UfsTaurusPlugin::terminate() {
    psc_dbgmsg( PSC_SELECTIVE_DEBUG_LEVEL( AutotunePlugins ), "UfsTaurusPlugin: call to terminate()\n" );
}
 ...
 *
 * return a pointer to a new UfsTaurusPlugin();
 *
 * @ingroup UfsTaurusPlugin
 *
 * @return A pointer to a new UfsTaurusPlugin
...
IPlugin* getPluginInstance( void ) {
    psc_dbgmsg( PSC_SELECTIVE_DEBUG_LEVEL( AutotunePlugins ), "UfsTaurusPlugin: call to getPluginInstance()\n" );
    return new UfsTaurusPlugin();
}
...
int getVersionMajor( void ) {
    psc_dbgmsg( PSC_SELECTIVE_DEBUG_LEVEL( AutotunePlugins ), "UfsTaurusPlugin: call to getInterfaceVersionMajor()\n" );
    return 1;
}
...
int getVersionMinor( void ) {
    psc_dbgmsg( PSC_SELECTIVE_DEBUG_LEVEL( AutotunePlugins ), "UfsTaurusPlugin: call to getInterfaceVersionMinor()\n" );
 ...
 */
string getName( void ) {
    psc_dbgmsg( PSC_SELECTIVE_DEBUG_LEVEL( AutotunePlugins ), "UfsTaurusPlugin: call to getName()\n" );
    return "UfsTaurusPlugin";
}
...
string getShortSummary( void ) {
    psc_dbgmsg( PSC_SELECTIVE_DEBUG_LEVEL( AutotunePlugins ), "UfsTaurusPlugin: call to getShortSummary()\n" );
