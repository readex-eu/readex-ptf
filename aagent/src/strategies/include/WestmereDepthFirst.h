/**
   @file    WestmereDepthFirst.h
   @ingroup WestmereDepthFirst
   @brief   Westmere stall cycles depth-first search strategy header
...
/**
 * @defgroup WestmereDepthFirst Westmere Depth-First Analysis Strategy
 * @ingroup Strategies
 */

#ifndef WestmereDepthFirst_H_
#define WestmereDepthFirst_H_
#include "global.h"
...
class WestmereDepthFirst : public Strategy {
private:
    Region*   phaseRegion;
...
public:
    WestmereDepthFirst( bool pedantic = false );
