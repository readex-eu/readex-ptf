...
/**
 * @defgroup GPUTestingStrategy GPU Testing Analysis Strategy
 * @ingroup Strategies
 */

#ifndef GPUTESTINGSTRATEGY_H_
#define GPUTESTINGSTRATEGY_H_
#include "global.h"
...
class GPUTestingStrategy : public Strategy {
private:
    Region*   phaseRegion;
...
public:
    GPUTestingStrategy( bool pedantic = false ) {
    }
    ~GPUTestingStrategy() {
    }
