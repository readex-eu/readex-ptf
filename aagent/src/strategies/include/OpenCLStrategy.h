...
/**
 * @defgroup OpenCLStrategy OpenCL Analysis Strategy
 * @ingroup Strategies
 */

#ifndef OPENCLSTRATEGY_H_
#define OPENCLSTRATEGY_H_
#include "global.h"
#include "application.h"
#include "Metric.h"
#include "strategy.h"

class OpenCLStrategy : public Strategy {
private:
    Region*   phaseRegion;
...
public:
    OpenCLStrategy( bool pedantic = false ) {
    }
