...
#ifndef OPENMPANALYSIS_H_
#define OPENMPANALYSIS_H_
#include "global.h"
...
class OpenMPAnalysis : public Strategy {
private:
    Region*   phaseRegion;
...
public:
    OpenMPAnalysis( bool pedantic = false ) : Strategy( pedantic ) {
    }
