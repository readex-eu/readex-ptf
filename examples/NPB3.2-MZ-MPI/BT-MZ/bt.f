...
#include </home/hpc/h039w/h039waa/install/scorep/include/scorep/SCOREP_User.inc>
!#include </lrz/sys/tools/scorep/1.4.2/intel3.Thin_Node/include/scorep/SCOREP_User.inc>
!-------------------------------------------------------------------------!
!                                                                         !
...
c---------------------------------------------------------------------
     ...
     >                  iz, ip, tot_threads, itimer, outer
...
c---------------------------------------------------------------------
       ...
       do  step=1,niter
        SCOREP_USER_OA_PHASE_BEGIN( my_region_handle, "PhaseRegion", 0)
           call timer_clear(1)
       call timer_start(1)
